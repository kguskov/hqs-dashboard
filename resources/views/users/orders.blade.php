...
@section('bookmark')
    <div class="col">
        <div class="bookmark pull-right">
            <a class="btn btn-success btn m-2" href="#" data-original-title="" title=""><span
                        class="fa fa-plus"></span> {{ __('messages.pages.orders.add')}}</a>
        </div>
    </div>
@endsection
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-secondary btn-sm"
                                                       title="{{ __('messages.pages.orders.edit')}}"> <span
                                                                class="fa fa-pencil"></span> </a>
                                                    <a href="#" class="btn btn-danger btn-sm"
                                                       title="{{ __('messages.pages.orders.delete')}}"> <span
