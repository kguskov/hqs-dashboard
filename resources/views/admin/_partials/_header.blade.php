            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown"><i data-feather="bell"></i><span class="dot"></span>
                    <ul class="notification-dropdown onhover-show-div">
                        <li>{{__('messages._header.notifications')}} <span
                                    class="badge badge-pill badge-primary pull-right">3</span></li>
                        <li>
                            <div class="media">
                                <div class="media-body">
                                    <h6 class="mt-0"><span><i class="shopping-color"
                                                              data-feather="shopping-bag"></i></span>{{__('messages._header.orderIsReady')}}
                            ...
                            <div class="media">
                                <div class="media-body">
                                    <h6 class="mt-0 txt-success"><span><i class="download-color font-success"
                                                                          data-feather="download"></i></span>{{__('messages._header.documentRecieved')}}
                                        <small class="pull-right">2:30 PM</small></h6>
                                    <p class="mb-0">{{__('messages._header.lorem')}}</p>
                                </div>
                            </div>
                        </li>
                ...
                <li class="onhover-dropdown">
                    ...
                    <ul class="profile-dropdown onhover-show-div p-20">
                        ...
                        <li><a href="settings"><i data-feather="settings"></i>{{__('messages._header.settings')}}</a>
                        </li>
                        <li><a href="/logout"
